          ...
          return Obx(() => SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    if (homeController.showRandomStoryInfo.value)
                      Container(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Expanded(
                                    child: GradientText(
                                        'Use the given random word in a sentence or paragraph to proceed further.',
                                        gradient: greenGradient)),
                              ],
                            ),
                            const SizedBox(
                            ...
                            Row(
                              children: [
                                ...
                                Expanded(
                                    child: GradientText(
                                        'Previous story cannot be edited.',
                                        gradient: greenGradient)),
                              ],
                            ),
                          ],
                    ...
                    InkWell(
                        ...
                        child: GradientText(
                          (homeController.randomWord.value.isEmpty
                                  ? 'Tap on Get word to Start'
                                  : '""" ${homeController.randomWord.value} """')
                              .toUpperCase(),
                                            ...
                                            child: InkWell(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  GradientText('Upload Image',
                                                      gradient: blueGradient),
                                                  const SizedBox(
                                                    width: 10,
                                                  ),
                                                  if (homeController.file.value
                                                          .path.isNotEmpty ||
                                                      homeController.newImage
                                                          .text.isNotEmpty)
                                                    Expanded(
                                                      child: Padding(
                                                        padding:
                                  ...
                                  child: InkWell(
                                    onTap: () {
                                      FocusManager.instance.primaryFocus
                                          ?.unfocus();
                                      if (homeController.newLine.text.contains(
                                          homeController.randomWord.value)) {
                                        debugPrint(
                                            '${homeController.randomWord.value}');
                                        debugPrint(
                                            '${homeController.story.value}');
                                        homeController
                                            .newStory.text = homeController
                                                .story.value +
                                            ' ' +
                                            homeController.newLine.text.replaceAll(
                                                homeController.randomWord.value,
                                                '<b>${homeController.randomWord.value}</b>');
                                        // homeController.story.value =
                                        //     homeController.newStory.text;
                                        debugPrint(
                                            homeController.newStory.text);
                                        homeController.addStory(context);
                                      } else {
                                        showSnackbar(context,
                                            'Please use the given word in your paragraph or sentence. Tap on the word to see the meaning.');
                                      }
                                    },
                                    child: NeumorphismContainer(
                                      width: 200,
