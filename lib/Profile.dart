        ...
        builder: (_) {
          return StreamBuilder(
              stream: controller.firestore
                  ...
                  .where('uuid', isEqualTo: authController.getCurretUId())
                  .snapshots(),
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  GradientText(
                                    '${authController.name.value.isNotEmpty ? authController.name.value : 'user name'}',
                                                      ...
                                                      children: [
                                                        ...
                                                        Expanded(
                                                          child: snapshot
                                                              ...
                                                              ? InkWell(
                                                                  onTap: () {
                                                                    controller.selectStory(snapshot
                                                                        .data!
                                                                        .docs[index *
                                                                            2 +
                                                                        1]);
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            AspectRatio(
                                                                                aspectRatio: 1,
                                                                                child: Image.network(
                                                                                  snapshot.data!.docs[index * 2 + 1]['image'],
                                                                                  fit: BoxFit.cover,
                                                                                  errorBuilder: errorBuilder,
                                                                                )),
                                                                            SizedBox(
                                                                            ...
                                                                            GradientText(
                                                                              snapshot.data!.docs[index * 2 + 1]['title'],
                                                                              gradient: greyGradient,
                                                        ...
                                                        //                         aspectRatio: 1,
                                                        //                         child: Image.network(
                                                        //                           snapshot.data!.docs[index * 3 + 2]['image'],
                                                        //                           fit: BoxFit.cover,
                                                        //                           errorBuilder: errorBuilder,
                                                        //                         )),
                                                        //                     GradientText(
                                                        //                       snapshot.data!.docs[index * 3 + 2]['title'],
                                                        //                       gradient: greyGradient,
                                                        //                     )
                                                        //                   ],
                                                        //                 ),
